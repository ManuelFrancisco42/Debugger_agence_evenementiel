...
const Select = ({
  ...
  const changeValue = (newValue) => {
    // I jointed the newvalue as a parameter to the onChange() function before onChange( ) after onChange(newValue);
    onChange(newValue);
    setValue(newValue);
    setCollapsed((currentCollapsed) => !currentCollapsed); // Toggle the state of collapsed using its current value.
  };
  return (
