    ...
    <>
      ...
      <footer data-testid='footer-testid' className='row'>
        <div className='col presta' data-testid='last-event'>
          ...
          {/* check if "lastEvent" exists and if both "lastEvent.cover" and "lastEvent.title" are defined. */}
          {lastEvent && lastEvent.cover && lastEvent.title ? (
            <EventCard
              ...
              label='boom'
            />
          ) : // check If any of the preceding conditions is not met, return nothing (null).
          null}
        </div>
